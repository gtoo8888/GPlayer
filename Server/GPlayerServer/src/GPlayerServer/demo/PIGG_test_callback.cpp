...
void programA_FunA1() {
    printf("programA_FunA1 \n");
}                // 普通函数
void programA_FunA2() {
    printf("callback programA_FunA2 \n");
}                // 普通函数作为回调函数
...
public:
    void funa1() {
        printf("programA.funa1() \n");
    }  // 普通函数

    static void funa2() {
        printf("static callback programA.funa2() \n");
    }  // 静态函数作为回调函数
};
class programB {
public:
...
public:
    void funa1() {
        printf("programA2.funa1() \n");
    }  // 普通函数

    void funa2() {
        printf("programA2.funa2() \n");
    }
};
...
public:
    void funa1() {
        printf("programA3.funa1() \n");
    }  // 普通函数

    void funa2() {
        printf("programA3.funa2() \n");
    }
...
public:
    void funa1() {
        printf("programA4.funa1() \n");
    }
    void funa2() {
        printf("programA4.funa2() \n");
    }
    static void funa3() {
        printf("programA4.funa3() \n");
    }
};
